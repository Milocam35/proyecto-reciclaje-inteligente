          ...
          <div className="w-full max-w-6xl bg-white shadow-lg rounded-2xl p-8 mt-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="space-y-6 p-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-900 text-lg border border-gray-300 rounded-lg p-3">
                      {user.name}
                    </p>
                  </div>
                  <div>
              ...
              <div className="flex flex-col justify-center space-y-6 p-6">
                <button className="w-full bg-blue-500 text-white py-4 rounded-xl hover:bg-blue-600 transition font-medium text-lg cursor-pointer">
                  Editar información
                </button>
                <button
                  onClick={() => setShowLogoutConfirm(true)}
                  className="w-full bg-red-500 text-white py-4 rounded-xl hover:bg-red-600 transition font-medium text-lg cursor-pointer"
                >
                  Cerrar sesión
                </button>
                {showLogoutConfirm && <LogoutPopUp setShowLogoutConfirm={setShowLogoutConfirm} handleLogout={onLogout} />}
              </div>
            </div>
          </div>
        </div>
